                    ...
                    <div class="">
                        ...
                        <x-dropdown align="right" width="48">
                            <x-slot name="trigger">
                                ...
                                <button
                                    class="border inline-flex items-center mt-[1rem] w-[35rem] px-3 py-2 text-sm font-medium leading-4 text-gray-500 transition duration-150 ease-in-out bg-white border border-transparent rounded-md hover:text-gray-700 focus:outline-none">
